    ...
    <form method="post" class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input id="title" type="text" class="input-text" value="<?PHP echo $title;?>">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>职位部门：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input id="department" type="text" class="input-text" value="<?PHP echo $department;?>">
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
    ...
    function save() {
        ...
        $.ajax({
            type: "POST",
            url: "base/recruitSave.php",
            dataType: "json",
            data: {"id": id, "title": title,"department":department,"content":um.getContent()},
