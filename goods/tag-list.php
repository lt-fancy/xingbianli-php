...
<div class="page-container">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
            ...
            $sql = $mysqli->query("select * from state_info where ename='goods_tag' order by gmt_modified desc");
...
<script type="text/javascript">
    ...
    $('.editable-cname', oTable.fnGetNodes()).editable('../base/tagSave.php', {
