...
$sql = $mysqli->query("select * from common_info where common_ename='hotline' and is_deleted=0");
    ...
    <form method="post" class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input id="title" type="text" class="input-text" value="<?PHP echo $content;?>">
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
    function save() {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: {"ename": 'hotline',"content":content},
