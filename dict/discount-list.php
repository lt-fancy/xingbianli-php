...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 字典管理 <span class="c-gray en">&gt;</span> 随机折扣列表 <a id="refresh" class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel(0)" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6dc;</i> 批量上线</a> <a href="javascript:;" onclick="datadel(1)" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6de;</i> 批量下线</a> <a class="btn btn-primary radius" data-title="添加随机折扣" data-href="article-add.html" onclick="add_news()" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加随机折扣</a></div>
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
            ...
            <tr class="text-c">
                ...
                <th width="80">字典id</th>
                <th width="100">随机折扣</th>
                <th width="100">出现概率</th>
            ...
            $sql = $mysqli->query("select * from state_info where ename='random_discount' order by gmt_modified desc");
...
<script type="text/javascript">
    ...
    $('.editable-cname', oTable.fnGetNodes()).editable('../base/discountSave.php', {
    ...
    function datadel(type) {
        ...
        if (vals.length < 1) {
            ...
            var ids = vals.join(',');
            commonOnline(text + vals.length + '个商品标签吗？',ids,type);
        }
    }
