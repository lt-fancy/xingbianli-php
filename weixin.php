...
$sql = $mysqli->query("select * from common_info where common_ename='weixin' and is_deleted=0");
...
<div class="page-container">
    <form method="post" class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">新闻封面图片：</label>
...
//        fileSingleSizeLimit:409600
    ...
    function save() {
        $.ajax({
            ...
            dataType: "json",
            data: {"ename": 'weixin',"content":file_name},
